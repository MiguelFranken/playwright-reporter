...
import { BranchSummaryTable } from '@repo/ui/views/dashboard/branch-summary-table';
import { MetricCard, toneClass } from '@repo/ui/patterns/metric-card';
import { PassFailChart } from '@repo/ui/views/dashboard/pass-fail-chart';
import { ChronicFailuresList, FlakyTestsList } from '@repo/ui/views/dashboard/test-health-lists';
...
import { ChartSkeleton, ListRowsSkeleton, MetricCardsSkeleton, TableRowsSkeleton } from '@repo/ui/patterns/skeletons';
...
import { formatDuration, formatPercent } from '@repo/ui/lib/format';
