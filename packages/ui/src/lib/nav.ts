...
/**
 * The team the URL points at. Off a team route (`/admin`, `/account`) there is
 * no slug to read, and the first team stands in so the sidebar keeps its shape
 * instead of collapsing to an admin-only menu.
 */
